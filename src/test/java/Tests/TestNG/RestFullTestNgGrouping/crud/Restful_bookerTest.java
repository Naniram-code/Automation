...
public class Restful_bookerTest extends BaseTest {
    private static final Logger log = LogManager.getLogger(CreateBookingTest.class);
    //Global variable
    String BASE_URI = PropertyReaderOptimized.readKey("url","data.properties");//properties file reader
    String BookingID;//String BASE_URI = "https://restful-booker.herokuapp.com";

    public Restful_bookerTest() throws Exception {
    }
